  ...
  return (
    <div className="min-h-screen bg-amber-50 flex items-center justify-center p-4" style={{backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23d4a574\' fill-opacity=\'0.05\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")'}} >
      <div className="w-full max-w-md">
        ...
        <div className="relative bg-gradient-to-b from-amber-100 to-amber-50 rounded-sm shadow-2xl p-12 border-4 border-amber-900 border-opacity-20" style={{boxShadow: '0 20px 40px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.6)'}}>
          {/* Corner decorations */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input 
                className="w-full border-2 border-amber-900 border-opacity-30 bg-white bg-opacity-70 px-4 py-3 focus:outline-none focus:border-amber-800 text-amber-950 placeholder-amber-700 placeholder-opacity-50 transition" 
                style={{fontFamily: 'Georgia, serif', color: '#3d2817'}}
          ...
          {/* Footer info */}
          <p className="text-center text-xs text-amber-700 font-light" style={{fontFamily: 'Georgia, serif', letterSpacing: '0.05em'}}>
            演示帳戶：admin / admin123
          </p>
        </div>
